...
const VisitGet = lazy(
  () =>
    import(
      '@/Pages/MainTabs/Testing/End2End/Cypress/Basics/CoreCommands/VisitGet'
    )
);
...
const ContainsFind = lazy(
  () =>
    import(
      '@/Pages/MainTabs/Testing/End2End/Cypress/Basics/CoreCommands/ContainsFind'
    )
);
...
const AssertionsOverview = lazy(
  () =>
    import(
      '@/Pages/MainTabs/Testing/End2End/Cypress/Basics/CoreCommands/Assertions'
    )
);

...
const Overview = lazy(
  () => import('@/Pages/MainTabs/BackEndPages/DatabasesPages/MongoDB/Basics/Mongoose/Overview')
);
const SchemasAndModels = lazy(
  () =>
    import('@/Pages/MainTabs/BackEndPages/DatabasesPages/MongoDB/Basics/Mongoose/SchemasAndModels')
);

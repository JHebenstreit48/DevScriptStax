...
const Transforms = lazy(
    () => import("@/Pages/MainTabs/FrontEnd/CSS/Advanced/Effects/Transforms")
);
const Transitions = lazy(
    () => import("@/Pages/MainTabs/FrontEnd/CSS/Advanced/Effects/Transitions")
);
const Animations = lazy(
    () => import("@/Pages/MainTabs/FrontEnd/CSS/Advanced/Effects/Animations")
);

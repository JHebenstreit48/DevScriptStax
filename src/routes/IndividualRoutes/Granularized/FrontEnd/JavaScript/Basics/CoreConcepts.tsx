...
const SyntaxStructure = lazy(
  () =>
    import(
      "@/Pages/MainTabs/FrontEnd/JavaScript/Basics/CoreConcepts/SyntaxAndStructure"
    )
);
const JSVariables = lazy(
  () =>
    import(
      "@/Pages/MainTabs/FrontEnd/JavaScript/Basics/CoreConcepts/Variables"
    )
);
const Operators = lazy(
  () =>
    import(
      "@/Pages/MainTabs/FrontEnd/JavaScript/Basics/CoreConcepts/Operators"
    )
);
const BuiltInMethods = lazy(
  () =>
    import(
      "@/Pages/MainTabs/FrontEnd/JavaScript/Basics/CoreConcepts/BuiltInMethods"
    )
);
const Conditionals = lazy(
  () =>
    import(
      "@/Pages/MainTabs/FrontEnd/JavaScript/Basics/CoreConcepts/Conditionals"
    )
);
const Loops = lazy(
  () =>
    import(
      "@/Pages/MainTabs/FrontEnd/JavaScript/Basics/CoreConcepts/Loops"
    )
);
const ScopeAndContext = lazy(
  () =>
    import(
      "@/Pages/MainTabs/FrontEnd/JavaScript/Basics/CoreConcepts/ScopeAndContext"
    )
);

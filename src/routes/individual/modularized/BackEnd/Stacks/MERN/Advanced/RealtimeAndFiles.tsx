...
const SocketIOIntegration = lazy(() => import('@/pages/mainTabs/BackEnd/Stacks/MERN/Advanced/RealtimeAndFiles/SocketIOIntegration'));
const FileUploadsPipeline = lazy(() => import('@/pages/mainTabs/BackEnd/Stacks/MERN/Advanced/RealtimeAndFiles/FileUploadsPipeline'));
